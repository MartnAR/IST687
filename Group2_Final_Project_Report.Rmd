...
```{r}
prem <- prem <- read.csv("http://www.football-data.co.uk/mmz4281/1718/E0.csv")
head(prem)
```
...
ggplot(dataset, aes(reorder(person_marital_status, table(person_marital_status)[person_marital_status]))) +
  geom_bar() +
  coord_flip() +
